...
public:
	...
	static Relay* shooterDiskPusher;
	...
	static SpeedController* climberClimberTalon1;
	static Relay* climberClimberBeltSystem;
	static Servo* climberDiskStopper1;
	static Servo* climberDiskStopper2;
